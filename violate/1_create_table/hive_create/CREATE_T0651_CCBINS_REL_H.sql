...
ALTER TABLE CT_T0651_CCBINS_REL_H_MID ADD PARTITION(DATA_TYPE='SRC');
ALTER TABLE CT_T0651_CCBINS_REL_H_MID ADD PARTITION(DATA_TYPE='CUR_NO_DUP');
ALTER TABLE CT_T0651_CCBINS_REL_H_MID ADD PARTITION(DATA_TYPE='PRE_NO_DUP');
